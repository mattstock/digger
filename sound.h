...
/*
void soundoff(void);
void timer2(unsigned short t2v);
*/

extern bool soundflag,musicflag;
extern short volume,timerrate;
...
extern void (*settimer0)(unsigned short t0v);
extern void (*timer0)(unsigned short t0v);
extern void (*settimer2)(unsigned short t2v);
extern void (*timer2)(unsigned short t2v);
