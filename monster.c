...
struct monster
{
  short x,y,h,v,xr,yr,dir,hdir,t,hnt,death,bag,dtime,stime,chase;
  bool flag,nob,alive;
} mondat[6];

short nextmonster=0,totalmonsters=0,maxmononscr=0,nextmontime=0,mongaptime=0;
short chase=0;
